	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'child' ) . '" data-uploader_button_text="' . __( 'Use image', 'child' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'child' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'child' ) . '" />' . "\n";
